...
eventTime.toLocaleTimeString() // 9:37:35 AM
eventTime.getHours() // getMinutes(), getSeconds(), getMilliseconds()
...
const year = eventTime.getFullYear() // 2021. `getYear()` is deprecated
...
const isoString = eventTime.toISOString()
