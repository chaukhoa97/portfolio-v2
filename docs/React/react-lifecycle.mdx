...
4. (Minor) `useLayoutEffect` to avoid flashes or flickers
5. [Browser repaint the screen](#epilogue-browser-paint)
6. `useEffect` after to release the thread before effects
