...
| [Sorting](https://beta.reactjs.org/learn/updating-arrays-in-state#making-other-changes-to-an-array) | `sort`, `reverse`                   | Copy the array by spread syntax first (`const nextList = [...list] -> nextList.reverse()`) |
