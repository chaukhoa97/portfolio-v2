...
React Query **caches** the data, so we don't need to have concern about fetching the same data in mutiple components. It also gives you a lot of features like retries, placeholder data, prefetching, optimistic updates...
